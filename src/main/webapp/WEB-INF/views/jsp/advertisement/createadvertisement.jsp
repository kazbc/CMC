                                    ...
                                    <div class="col-xs-12">
                                        <div class="card">
                                            ...
                                            <div class="card-content">
                                                <form:form commandName="advertisementForm">
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="control-label">Height above ground level <samp style="color: red">*</samp></label>
                                                    ...
                                                    <button type="button" id="btncreateapplication" class="btn btn-primary pull-right">Create Application</button>
        ...
        <script type="text/javascript">
            ...
            $("#btncreateapplication").click(function () {
                ...
                if ($("#advertisementForm").valid()) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "${pageContext.servletContext.contextPath}/createadvertisement",
                        ...
                        success: function (response, textStatus, jqXHR) {
                            ...
                            if (response.CODE === "SUCCESS") {
                                demo.showNotificationPanel("ID: " + response.MESSAGE + "<br>" + "Application Created Successfully !", "done", 1, "top", "right");
                                window.scrollTo(0, 0);
                            } else {
                                demo.showNotificationPanel("Error occured while creating the application !", "info_outline", 4, "top", "right");
                                window.scrollTo(0, 0);
                            }
